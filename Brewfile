...
brew "coreutils"
brew "fzf"
brew "fzf-tab" # zshfzftab.zsh sources it
brew "eza"
brew "bat" # fzf-tab file previews
brew "ripgrep"
brew "fd" # zshbindkeys.zsh ctrl+p / ctrl+g pickers
brew "pwgen"
brew "watch"
...
brew "lazygit"
brew "difftastic"
brew "git-delta" # git config sets delta as the pager; git is unusable without it
